...
class Ui_CT_controller(object):
    def setupUi(self, CT_controller):
        ...
        self.horizontalLayout.addWidget(self.radioButton_Medipix)
        ...
        self.horizontalLayout.addWidget(self.radioButton_Flatpanel)
        ...
        self.label_Flatpanel = QtWidgets.QLabel(self.centralwidget)
        self.label_Flatpanel.setGeometry(QtCore.QRect(30, 360, 561, 91))
